...
export default function Noty({ width, color, count }: NotyProps) {
  return (
    <div className="flex justify-end">
      <div style={notyIconStyle} className="flex items-center mt-2">
        {count > 0 ? <div style={notyNumStyle} className="bg-accent">{count}</div> : null}
        <svg
          viewBox="0 0 24 24"
